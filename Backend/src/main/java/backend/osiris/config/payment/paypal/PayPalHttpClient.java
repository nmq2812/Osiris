package backend.osiris.config.payment.paypal;

import backend.osiris.dto.payment.AccessTokenResponse;
import backend.osiris.dto.payment.ClientTokenResponse;
