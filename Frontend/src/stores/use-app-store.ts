...
import createAdminSiteSlice, {
    AdminSiteState,
} from "./create-admin-site-slice";
import createManagePageSlice, {
    ManagePageState,
} from "./create-manage-page-slice";
    ...
    [key]:
        typeof value === "function"
            ? (value as (prevState: T) => T)(
                  state[key as keyof S] as unknown as T,
              )
            : value,
});
