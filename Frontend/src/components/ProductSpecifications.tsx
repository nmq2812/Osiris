...
import ProductSpecificationRow from "./ProductSpecificationRow";
...
function ProductSpecifications({
    ...
    const isDisabledCreateProductSpecificationButton =
        specifications?.content.length === specificationSelectList.length;
    ...
    const handleCreateProductSpecificationButton = () => {
        ...
        currentSpecificationItems.push({
            id: 0,
            name: "",
            code: "",
            value: "",
    ...
    const productSpecificationsFragment = specifications?.content.map(
        (specification, index) => (
