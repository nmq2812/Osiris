        ...
        <Stack>
            <Box ref={refBox}>
                <Popover
                    ...
                    target={
                        <TextInput
                            ...
                            icon={<Search size={14} />}
                            rightSection={
                                isFetching ? <Loader size={16} /> : null
                            }
                ...
                >
                    <Stack spacing={0}>
                        {!entityResponses ||
                        entityResponses.totalElements === 0 ? (
                            <Text
                                size="sm"
                                p="sm"
                                color="dimmed"
                            ...
                            entityResponses.content.map((entityResponse) => {
                                const disabled = selectionIds.includes(
                                    entityResponse.id,
                                );
                    ...
                    {selections.map((selectedEntityResponse) => (
                        ...
                        >
                            ...
                            <ActionIcon
                                ...
                                onClick={() =>
                                    onDeleteItem(selectedEntityResponse)
                                }
                            >
                                <Trash size={16} />
                            </ActionIcon>
