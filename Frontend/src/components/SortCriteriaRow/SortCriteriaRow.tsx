...
import useSortCriteriaRowViewModel from "./SortCriteriaRow.vm";
...
function SortCriteriaRow({ sortCriteria, index }: SortCriteriaRowProps) {
    const {
        ...
        >
            ...
            <Select
                ...
                onChange={(propertyValue) =>
                    handleSortPropertySelect(propertyValue, index)
                }
            />
            <Select
                sx={{ width: "100%" }}
                ...
                onChange={(orderValue) =>
                    handleSortOrderSelect(orderValue, index)
                }
            />
            <ActionIcon
                color="red"
