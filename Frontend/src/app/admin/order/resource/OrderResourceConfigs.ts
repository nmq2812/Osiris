...
class OrderResourceConfigs extends Configs {
    ...
    static properties =
        OrderResourceConfigs._rawProperties as EntityPropertySchema<
            typeof OrderResourceConfigs._rawProperties &
    ...
    static createUpdateFormSchema = z.object({
        ...
        name: z
            ...
            .min(
                2,
                MessageUtils.min(OrderResourceConfigs.properties.name.label, 2),
            ),
        color: z.string(),
