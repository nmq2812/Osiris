...
import { ColorSwatch, Stack } from "tabler-icons-react";
...
class OrderConfigs extends Configs {
    ...
    static properties = OrderConfigs._rawProperties as EntityPropertySchema<
        typeof OrderConfigs._rawProperties & typeof PageConfigs.properties
    >;
