...
class SupplierConfigs extends Configs {
    ...
    static properties = SupplierConfigs._rawProperties as EntityPropertySchema<
        typeof SupplierConfigs._rawProperties & typeof PageConfigs.properties
    >;
    ...
    static createUpdateFormSchema = z.object({
        displayName: z
            ...
            .min(
                2,
                MessageUtils.min(
                    SupplierConfigs.properties.displayName.label,
                    2,
                ),
            ),
        code: z.string(),
