...
function UnitUpdate() {
    ...
    // Đồng bộ dữ liệu từ unit xuống form
    useEffect(() => {
        if (unit && !formInitialized.current) {
            form.setFieldsValue({
                name: unit.name,
    ...
    useEffect(() => {
        if (updateStatus === "success") {
            ...
            api.error({
                message: "Lỗi",
                description: "Có lỗi xảy ra khi cập nhật đơn vị.",
            });
        }
    }, [updateStatus, api]);

    // Xử lý submit form
    const onFinish = (values: { name: any; status: any }) => {
        ...
        <>
            ...
            >
                ...
                <DefaultPropertyPanel
                    ...
                    createdBy={unit.createdBy?.username || "-"}
                    updatedBy={unit.updatedBy?.username || "-"}
                />
