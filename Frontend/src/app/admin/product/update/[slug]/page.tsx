...
import ProductVariantsForUpdate from "@/components/ProductVariantsForUpdate";
        ...
        if (product) {
            form.setFieldsValue({
                ...
                supplierId: product.supplier?.id
                    ...
                    : null,
                unitId: product.unit?.id ? String(product.unit?.id) : null,
                tags: product.tags.map((tag) => String(tag.id) + "#ORIGINAL"),
                weight: product.weight,
                guaranteeId: product.guarantee?.id
                    ? String(product.guarantee?.id)
                    : null,
            });
        }
    }, [product, form]);
                        ...
                        <div>
                            ...
                            <div style={{ marginTop: 16 }}>
                                <ProductImagesDropzone
                                    ...
                                    setImageResponses={(imageResponses: any) =>
