    ...
    const entityDetailTableRowsFragment = (entity: EmployeeResponse) => (
        <>
            ...
            <tr>
                <td>
                    {
                        EmployeeConfigs.properties["user.address.province.name"]
                            .label
                    }
                </td>
            ...
            <tr>
                <td>
                    {
                        EmployeeConfigs.properties["user.address.province.code"]
                            .label
                    }
                </td>
            ...
            <tr>
                <td>
                    {
                        EmployeeConfigs.properties["user.address.district.name"]
                            .label
                    }
                </td>
            ...
            <tr>
                <td>
                    {
                        EmployeeConfigs.properties["user.address.district.code"]
                            .label
                    }
                </td>
            ...
            <tr>
                ...
                <td>
                    {departmentStatusBadgeFragment(entity.department.status)}
                </td>
            </tr>
            <tr>
