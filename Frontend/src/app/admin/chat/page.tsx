...
function ChatDashboard() {
    ...
    useEffect(() => {
        if (roomResponses && roomResponses.totalElements > 0) {
                ...
                <Stack spacing={2}>
                    <Group>
                        <Text size="xs" color="dimmed">
                            ...
                            {DateUtils.isoDateToString(roomResponse.updatedAt)}
                        </Text>
                    </Group>
                    <Group spacing="xs">
...
function ChatPanel({ roomId }: { roomId: number }) {
    ...
    useEffect(() => {
        if (messageResponses && messageResponses.content) {
