...
class CountConfigs extends Configs {
    ...
    static properties = CountConfigs._rawProperties as EntityPropertySchema<
        typeof CountConfigs._rawProperties & typeof PageConfigs.properties
    >;
    ...
    static createUpdateFormSchema = z.object({
        code: z
            .string()
            .min(5, MessageUtils.min(CountConfigs.properties.code.label, 5)),
