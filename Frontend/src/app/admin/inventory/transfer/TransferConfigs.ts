...
class TransferConfigs extends Configs {
    ...
    static properties = TransferConfigs._rawProperties as EntityPropertySchema<
        typeof TransferConfigs._rawProperties & typeof PageConfigs.properties
    >;
    ...
    static createUpdateFormSchema = z.object({
        code: z
            .string()
            .min(5, MessageUtils.min(TransferConfigs.properties.code.label, 5)),
        "exportDocket.warehouseId": z.string({
            invalid_type_error: "Vui lòng không bỏ trống",
        }),
        "importDocket.warehouseId": z.string({
            invalid_type_error: "Vui lòng không bỏ trống",
        }),
        docketVariants: z
            .array(
