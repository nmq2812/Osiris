...
class PurchaseOrderConfigs extends Configs {
    ...
    static properties =
        PurchaseOrderConfigs._rawProperties as EntityPropertySchema<
            typeof PurchaseOrderConfigs._rawProperties &
    ...
    static createUpdateFormSchema = z.object({
        code: z
            ...
            .min(
                5,
                MessageUtils.min(PurchaseOrderConfigs.properties.code.label, 5),
            ),
        supplierId: z.string(),
        purchaseOrderVariants: z
            .array(
                z.object({
                    variantId: z.number(),
                    cost: z.number(),
