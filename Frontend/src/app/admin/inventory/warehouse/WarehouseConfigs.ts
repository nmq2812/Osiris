...
class WarehouseConfigs extends Configs {
    ...
    static properties = WarehouseConfigs._rawProperties as EntityPropertySchema<
        typeof WarehouseConfigs._rawProperties & typeof PageConfigs.properties
    >;
    ...
    static createUpdateFormSchema = z.object({
        ...
        name: z
            ...
            .min(
                2,
                MessageUtils.min(WarehouseConfigs.properties.name.label, 2),
            ),
