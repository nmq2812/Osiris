    ...
    const entityDetailTableRowsFragment = (entity: CustomerResponse) => (
        <>
            ...
            <tr>
                <td>
                    {
                        CustomerConfigs.properties["user.address.province.name"]
                            .label
                    }
                </td>
            ...
            <tr>
                <td>
                    {
                        CustomerConfigs.properties["user.address.province.code"]
                            .label
                    }
                </td>
            ...
            <tr>
                <td>
                    {
                        CustomerConfigs.properties["user.address.district.name"]
                            .label
                    }
                </td>
            ...
            <tr>
                <td>
                    {
                        CustomerConfigs.properties["user.address.district.code"]
                            .label
                    }
                </td>
