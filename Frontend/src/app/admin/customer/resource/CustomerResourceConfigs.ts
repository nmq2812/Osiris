...
class CustomerResourceConfigs extends Configs {
    ...
    static properties =
        CustomerResourceConfigs._rawProperties as EntityPropertySchema<
            typeof CustomerResourceConfigs._rawProperties &
    ...
    static createUpdateFormSchema = z.object({
        ...
        name: z
            ...
            .min(
                2,
                MessageUtils.min(
                    CustomerResourceConfigs.properties.name.label,
                    2,
                ),
            ),
